...
| [`migration_2to3_example.py`](migration_2to3_example.py) | Route a subset of DAGs to a 3.x pool for a safe 2→3 migration | `airflow.task.pool` |
| [`kubernetes_executor_rollout_example.py`](kubernetes_executor_rollout_example.py) | Canary a KubernetesExecutor change ([apache/airflow#68480](https://github.com/apache/airflow/pull/68480)) by routing a subset to a canary executor | `airflow.task.executor` |
